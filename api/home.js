...
// Lee el HTML base desde index1.html (en la raíz del proyecto).

const fs = require("fs");
const path = require("path");
const crypto = require("crypto");

const STORE_NAME_DEFAULT = "DS Distribuidora San Francisco No.1";
const DESC_DEFAULT = "Los mejores productos al mejor precio";
// Opcional: URL del logo ACTUAL, solo se usa si Firebase no responde.
const LOGO_RESPALDO = "";
const FIREBASE_URL =
  "https://dsdistribuidorasanfrancisco1-default-rtdb.firebaseio.com/settings.json";

let templateCache = null;
function loadTemplate() {
  if (templateCache) return templateCache;
  templateCache = fs.readFileSync(path.join(process.cwd(), "index1.html"), "utf8");
